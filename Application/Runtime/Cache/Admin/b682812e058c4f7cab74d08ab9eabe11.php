	...
	<div class="main-container container-fluid">
		<div class="sidebar" id="sidebar">
			...
			<ul class="nav nav-list">
			  <?php $__FOR_START_1841259615__=0;$__FOR_END_1841259615__=count($admin_menu_list);for($i=$__FOR_START_1841259615__;$i < $__FOR_END_1841259615__;$i+=1){ if(!empty($admin_menu_list[$i]['one'][0]['menu_name'])): ?><li>
                     <a href="javascript:load('<?php echo ($admin_menu_list[$i]['url']); ?>')" class="dropdown-toggle">
				      ...
				      <ul class="submenu">
                        ...
                        <?php $__FOR_START_1503014143__=0;$__FOR_END_1503014143__=count($admin_menu_list[$i]['one']);for($j=$__FOR_START_1503014143__;$j < $__FOR_END_1503014143__;$j+=1){ if(!empty($admin_menu_list[$i]['one'][$j]['sec'][0]['menu_name'])): ?><li>
                                <a href="javascript:load('<?php echo ($admin_menu_list[$i]['one'][$j]['url']); ?>')" class="dropdown-toggle">&nbsp;
                                  ...
                                  <ul class="submenu">
                                  	...
                                  	<?php $__FOR_START_1074529662__=0;$__FOR_END_1074529662__=count($admin_menu_list[$i]['one'][$j]['sec']);for($o=$__FOR_START_1074529662__;$o < $__FOR_END_1074529662__;$o+=1){ ?><li>
