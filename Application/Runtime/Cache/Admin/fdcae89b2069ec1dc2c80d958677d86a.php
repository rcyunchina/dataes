            ...
            <div class="table_full">
              <span>用户&nbsp;<?php echo ($admin_user_info['user']); ?>&nbsp;|&nbsp;<?php echo ($admin_user_info['user_name']); ?>&nbsp;权限设置</span>
                ...
                <table class="table table-bordered treeTable" id="authrule-tree">
                    <tbody>
                    <?php $__FOR_START_2012740514__=0;$__FOR_END_2012740514__=count($admin_menu);for($i=$__FOR_START_2012740514__;$i < $__FOR_END_2012740514__;$i+=1){ ?><tr id="node-1" style="" class="initialized parent expanded">
                        ...
                        <?php $__FOR_START_618626964__=0;$__FOR_END_618626964__=count($admin_menu[$i]['one']);for($j=$__FOR_START_618626964__;$j < $__FOR_END_618626964__;$j+=1){ ?><tr id="node-2" class="child-of-node-1 initialized parent expanded index<?php echo ($i); ?>" style="">
                            ...
                            <?php $__FOR_START_427633638__=0;$__FOR_END_427633638__=count($admin_menu[$i]['one'][$j]['sec']);for($o=$__FOR_START_427633638__;$o < $__FOR_END_427633638__;$o+=1){ ?><tr id="node-3" class="child-of-node-2 parent initialized sec<?php echo ($i); echo ($j); ?>" style="">
